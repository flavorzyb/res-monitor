...
public class FileCheckerTest extends TestCase
{
    ...
    public void testCheckPathcanExecute()
    {
        String path = "/usr/bin/svn";
        try
        {
            FileChecker.checkPathcanExecute(path);
        }
        catch (NullPointerException ex)
        {
            fail(ex.getMessage());
        ...
        try
        {
            FileChecker.checkPathcanExecute(null);
        }
        catch (NullPointerException ex)
        {
            assertTrue(ex instanceof NullPointerException);
        ...
        try
        {
            FileChecker.checkPathcanExecute("adsfasdfadf");
        }
        catch (NullPointerException ex)
        {
            fail(ex.getMessage());
